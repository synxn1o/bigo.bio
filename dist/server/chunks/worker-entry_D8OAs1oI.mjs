...
import { aZ as pipelineSymbol, bh as shouldAppendForwardSlash, b2 as removeTrailingForwardSlash, b as ActionNotFoundError, R as REDIRECT_STATUS_CODES, d as AstroError, c as ActionsReturnedInvalidDataError, W as ResponseSentError, ao as defineMiddleware, N as NOOP_MIDDLEWARE_HEADER, be as s, E as EndpointDidNotReturnAResponse, G as REROUTABLE_STATUS_CODES, J as REROUTE_DIRECTIVE_HEADER, aN as isPropagatingHint, aA as getPropagationHint$1, w as MissingMediaQueryDirective, z as NoMatchingImport, ar as escapeHTML, a7 as bufferPropagatedHead, aJ as isHeadAndContent, aR as isRenderTemplateResult, O as OnlyResponseCanBeReturned, aM as isPromise, a$ as promiseWithResolvers, ap as encoder, a8 as chunkToByteArray, aa as chunkToString, a9 as chunkToByteArrayOrString, bj as toAttributeString, aV as markHTMLString, b7 as renderSlotToString, aW as maybeRenderHead, ag as containsServerDirective, m as Fragment, b6 as renderSlot, ac as clsx, b8 as renderSlots, Y as ServerIslandComponent, ai as createAstroComponentInstance, U as Renderer, B as NoMatchingRenderer, av as formatList, x as NoClientOnlyHint, aF as internalSpreadAttributes, bl as voidElementNames, b9 as renderTemplate, aj as createRenderInstruction, b4 as renderElement$1, $ as SlotString, aX as mergeSlotInstructions, H as HTMLString, aI as isHTMLString, aQ as isRenderInstruction, aG as isAstroComponentInstance, aP as isRenderInstance, b3 as renderCspContent, aL as isNode, aH as isDeno, a4 as addAttribute, am as decryptString, ak as createSlotValueFromString, D as DEFAULT_404_COMPONENT, g as DEFAULT_404_ROUTE, an as default404Instance, az as getParams, a_ as prependForwardSlash, al as decodeKey, a1 as UnableToLoadLogger, X as RouteCache, bf as sequence, V as ReservedSlotName, S as ROUTE_TYPE_HEADER, a6 as appendForwardSlash, aE as i18nNoLocaleFoundInPath, M as MiddlewareNoDataOrNextCalled, t as MiddlewareNotAResponse, C as CacheNotEnabled, A as ASTRO_ERROR_HEADER, K as REWRITE_DIRECTIVE_HEADER_KEY, Q as REWRITE_DIRECTIVE_HEADER_VALUE, ae as collapseDuplicateSlashes, l as ForbiddenRewrite, ah as copyRequest, bg as setOriginPathname, aS as isRoute404, aT as isRoute500, aY as originPathnameSymbol, aw as generateCspDigest, a as ASTRO_GENERATOR, P as PrerenderClientAddressNotAvailable, f as ClientAddressNotAvailable, a0 as StaticClientAddressNotAvailable, bb as routeHasHtmlExtension, ad as collapseDuplicateLeadingSlashes, aB as getProps, as as fetchStateSymbol, e as AstroResponseHeadersReassigned, ba as responseSentSymbol$1, ay as getOriginPathname, s as LocalsReassigned, I as INTERNAL_RESPONSE_HEADERS, aq as escape, aK as isInternalPath, af as collapseDuplicateTrailingSlashes, aD as hasFileExtension, b0 as removeLeadingForwardSlash, aC as getRouteGenerator, Z as SessionStorageInitError, _ as SessionStorageSaveError, a5 as appSymbol, aU as joinPaths, r as LocalsNotAnObject, ab as clientAddressSymbol, at as fileExtension, bi as slash, bd as routeIsRedirect, bc as routeIsFallback, ax as getFallbackRoute, au as findRouteToRewrite } from "./params-and-props_BhIKCyxe.mjs";
...
const renderers = [];
const serializedData = [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "type": "page", "component": "_server-islands.astro", "params": ["name"], "segments": [[{ "content": "_server-islands", "dynamic": false, "spread": false }], [{ "content": "name", "dynamic": true, "spread": false }]], "pattern": "^\\/_server-islands\\/([^/]+?)\\/?$", "prerender": false, "isIndex": false, "fallbackRoutes": [], "route": "/_server-islands/[name]", "origin": "internal", "distURL": [], "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/_image", "component": "node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", "params": [], "pathname": "/_image", "pattern": "^\\/_image\\/?$", "segments": [[{ "content": "_image", "dynamic": false, "spread": false }]], "type": "endpoint", "prerender": false, "fallbackRoutes": [], "distURL": [], "isIndex": false, "origin": "internal", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/zh", "isIndex": true, "type": "page", "pattern": "^\\/zh\\/?$", "segments": [[{ "content": "zh", "dynamic": false, "spread": false }]], "params": [], "component": "src/pages/zh/index.astro", "pathname": "/zh", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "route": "/", "isIndex": true, "type": "page", "pattern": "^\\/$", "segments": [], "params": [], "component": "src/pages/index.astro", "pathname": "/", "prerender": false, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }];
serializedData.map(deserializeRouteInfo);
const _page0 = () => import("./image-transform-endpoint_BCQWGTjs.mjs").then((n) => n.i);
const _page1 = () => import("./index_DFjtcJq9.mjs");
const _page2 = () => import("./index_DCiGqodo.mjs");
const pageMap = /* @__PURE__ */ new Map([
  ["node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js", _page0],
  ["src/pages/zh/index.astro", _page1],
  ["src/pages/index.astro", _page2]
]);
const _manifest = deserializeManifest({"rootDir":"file:///mnt/e/bigo.bio/","cacheDir":"file:///mnt/e/bigo.bio/node_modules/.astro/","outDir":"file:///mnt/e/bigo.bio/dist/","srcDir":"file:///mnt/e/bigo.bio/src/","publicDir":"file:///mnt/e/bigo.bio/public/","buildClientDir":"file:///mnt/e/bigo.bio/dist/client/","buildServerDir":"file:///mnt/e/bigo.bio/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/@astrojs/cloudflare/dist/entrypoints/image-transform-endpoint.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ParticleAnimation.C_qvK-pO.css"},{"type":"inline","content":".hero-title[data-astro-cid-yg6xhirs]{font-size:clamp(2rem,8vw,3.5rem);line-height:1.1;font-weight:800;max-width:800px;overflow-wrap:break-word;word-wrap:break-word;hyphens:auto}.hero-subtitle[data-astro-cid-yg6xhirs]{font-size:clamp(1rem,4vw,1.25rem);max-width:600px;color:var(--color-grey-800)}@media(max-width:640px){.grid-item[data-astro-cid-yg6xhirs]{margin-top:6rem!important}}\n"}],"routeData":{"route":"/zh","isIndex":true,"type":"page","pattern":"^\\/zh\\/?$","segments":[[{"content":"zh","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/zh/index.astro","pathname":"/zh","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ParticleAnimation.C_qvK-pO.css"},{"type":"inline","content":".hero-title[data-astro-cid-j7pv25f6]{font-size:clamp(2rem,8vw,3.5rem);line-height:1.1;font-weight:800;max-width:800px;overflow-wrap:break-word;word-wrap:break-word;hyphens:auto}.hero-subtitle[data-astro-cid-j7pv25f6]{font-size:clamp(1rem,4vw,1.25rem);max-width:600px;color:var(--color-grey-800)}@media(max-width:640px){.grid-item[data-astro-cid-j7pv25f6]{margin-top:6rem!important}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":true,"experimentalQueuedRendering":{"enabled":false,"poolSize":0,"contentCache":false},"componentMetadata":[["/mnt/e/bigo.bio/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/mnt/e/bigo.bio/src/pages/zh/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_DsBX4kaI.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_Csu6PJY6.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_CFl7y3Qj.mjs","virtual:cloudflare/worker-entry":"entry.mjs","\u0000virtual:astro:page:src/pages/zh/index@_@astro":"chunks/index_DFjtcJq9.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DCiGqodo.mjs","/mnt/e/bigo.bio/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js":"chunks/image-service-workerd_hrXLi4jm.mjs","/mnt/e/bigo.bio/src/components/Navbar.astro?astro&type=script&index=0&lang.ts":"_astro/Navbar.astro_astro_type_script_index_0_lang.CONvpyCZ.js","/mnt/e/bigo.bio/src/components/ParticleAnimation.astro?astro&type=script&index=0&lang.ts":"_astro/ParticleAnimation.astro_astro_type_script_index_0_lang.vjJUzPmh.js","/mnt/e/bigo.bio/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts":"_astro/Layout.astro_astro_type_script_index_0_lang.D_hXm8Ph.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/mnt/e/bigo.bio/src/components/Navbar.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};const l=document.getElementById(\"mobile-toggle\"),n=document.getElementById(\"mobile-panel\"),s=document.getElementById(\"close-panel\"),t=document.getElementById(\"nav-overlay\");function e(o){o?(n?.classList.add(\"open\"),t?.classList.add(\"open\"),document.body.style.overflow=\"hidden\"):(n?.classList.remove(\"open\"),t?.classList.remove(\"open\"),document.body.style.overflow=\"\")}l?.addEventListener(\"click\",()=>e(!0));s?.addEventListener(\"click\",()=>e(!1));t?.addEventListener(\"click\",()=>e(!1));document.addEventListener(\"keydown\",o=>{o.key===\"Escape\"&&e(!1)});"],["/mnt/e/bigo.bio/src/components/ParticleAnimation.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};class x{x;y;size;speedX;speedY;canvas;ctx;constructor(h,i){this.canvas=h,this.ctx=i,this.x=Math.random()*h.width,this.y=Math.random()*h.height,this.size=Math.random()*2+.5,this.speedX=Math.random()*1-.5,this.speedY=Math.random()*1-.5}update(){this.x+=this.speedX,this.y+=this.speedY,this.x>this.canvas.width&&(this.x=0),this.x<0&&(this.x=this.canvas.width),this.y>this.canvas.height&&(this.y=0),this.y<0&&(this.y=this.canvas.height)}draw(){this.ctx.fillStyle=\"#E60000\",this.ctx.beginPath(),this.ctx.arc(this.x,this.y,this.size,0,Math.PI*2),this.ctx.fill()}}function d(){const s=document.getElementById(\"particle-canvas\"),h=document.getElementById(\"particle-container\");if(!s||!h)return;const i=s.getContext(\"2d\");if(!i)return;const a=()=>{const t=h.getBoundingClientRect();s.width=t.width,s.height=t.height};a(),window.addEventListener(\"resize\",a);const e=[],l=100;for(let t=0;t<l;t++)e.push(new x(s,i));function c(){if(!(!i||!s)){i.clearRect(0,0,s.width,s.height),i.strokeStyle=\"rgba(0, 0, 0, 0.05)\",i.lineWidth=.5;for(let t=0;t<e.length;t++)for(let n=t;n<e.length;n++){const o=e[t].x-e[n].x,r=e[t].y-e[n].y;Math.sqrt(o*o+r*r)<100&&(i.beginPath(),i.moveTo(e[t].x,e[t].y),i.lineTo(e[n].x,e[n].y),i.stroke())}for(const t of e)t.update(),t.draw();requestAnimationFrame(c)}}c()}d();document.addEventListener(\"astro:after-swap\",d);"],["/mnt/e/bigo.bio/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};document.querySelectorAll(\".lang-link\").forEach(a=>{a.addEventListener(\"click\",t=>{const e=t.currentTarget.getAttribute(\"data-lang\");e&&(document.cookie=`preferred-lang=${e}; path=/; max-age=31536000`)})});"]],"assets":["/_astro/ParticleAnimation.C_qvK-pO.css"],"i18n":{"fallbackType":"redirect","strategy":"pathname-prefix-other-locales","locales":["en","zh"],"defaultLocale":"en","domainLookupTable":{}},"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"ZAB/f52O5QJG6FUixT4YyZZhDeY6QT5nWJxArWiDUXY=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
