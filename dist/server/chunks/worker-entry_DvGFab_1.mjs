...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__$1, { _: "/mnt/e/bigo.bio/node_modules/.bin/astro", CC: "gcc" })?.PROD) {
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: "/mnt/e/bigo.bio/node_modules/.bin/astro" })?.DEV) {
...
export {
  ...
  MissingGetFontFileRequestUrl as M,
  NoImageMetadata as N,
  RemoteImageNotAllowed as R,
  UnsupportedImageConversion as U,
  ExpectedImageOptions as a,
  ExpectedNotESMImage as b,
  FontFamilyNotFound as c,
  IncompatibleDescriptorOptions as d,
  InvalidComponentArgs as e,
  InvalidImageService as f,
  MissingImageDimension as g,
  UnsupportedImageFormat as h,
  addAttribute as i,
  isRemoteAllowed as j,
  isRemotePath as k,
  joinPaths as l,
